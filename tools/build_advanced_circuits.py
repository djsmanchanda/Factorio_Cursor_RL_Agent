...
# Purpose: Plan or execute the surveyed raw-resource advanced-circuit factory.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Plan or execute the immutable raw-resource advanced-circuit factory."
    )
