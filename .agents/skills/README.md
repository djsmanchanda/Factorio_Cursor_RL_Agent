...
# Purpose: Inventory repository-local Codex skills for Factorio server operations.

# Repository Skills

| Skill | Use |
| --- | --- |
| [`factorio-server-rcon`](factorio-server-rcon/SKILL.md) | Safely choose raw RCON, GameBridge, or an authorized autonomous workflow |
