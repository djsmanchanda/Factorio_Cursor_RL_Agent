...
def _controller_snapshot(live_directory: Path | str) -> dict:
    ...
    return {
        ...
        "policy_learning_episodes": payload.get("policy_learning_episodes"),
        "policy_rejected_episodes": payload.get("policy_rejected_episodes"),
        "policy_advanced": payload.get("policy_advanced"),
